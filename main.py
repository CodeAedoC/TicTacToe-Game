...
X_IMAGE = pygame.image.load(os.path.join("TICTACTOE GAME","Assets","cross.png"))
X = pygame.transform.scale(X_IMAGE,(150,150))
O_IMAGE = pygame.image.load(os.path.join("TICTACTOE GAME","Assets","o.png"))
O = pygame.transform.scale(O_IMAGE,(150,150))
RETRY_IMAGE = pygame.image.load(os.path.join("TICTACTOE GAME","Assets","Retry.png"))
